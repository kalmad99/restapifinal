...
func (arh *AdminRoleHandler) GetRoles(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
...
func (arh *AdminRoleHandler) PostRole(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
