...
func NewCartRepository(CartRepo carts.CartRepository) carts.CartService {
	return &CartService{cartRepo: CartRepo}
}

func (cs *CartService) ItemsinCart() ([]Product, []error) {
	panic("implement me")
}

func (cs *CartService) IteminCart(id uint) (*Product, []error) {
	panic("implement me")
}

func (cs *CartService) EditCart(product *Product) (*Product, []error) {
	panic("implement me")
}

func (cs *CartService) DeleteItem(id uint) (*Product, []error) {
	panic("implement me")
}

func (cs *CartService) AddtoCart(product *Product) (*Product, []error) {
	panic("implement me")
}

// Categories returns list of categories
func (cs *CartService) Categories() ([]entity.Category, []error) {
...
func (cs *CartService) StoreCategory(category *entity.Category) (*entity.Category, []error) {
...
func (cs *CartService) Category(id uint) (*entity.Category, []error) {
...
func (cs *CartService) UpdateCategory(category *entity.Category) (*entity.Category, []error) {
...
func (cs *CartService) DeleteCategory(id uint) (*entity.Category, []error) {
...
func (cs *CartService) ItemsInCategory(category *entity.Category) ([]entity.Product, []error) {
